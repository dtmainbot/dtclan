...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (subcommand === 'user') {
            ...
            message.reply({content: `- Permissions granted to user <@${targetUser.id}> in your clan chat channel.`, flags: [ 4096 ]});
            ...
            message.reply({content: `- Permissions granted to role <@&${targetRole.id}> in your clan chat channel.`, flags: [ 4096 ]});
        } else {
