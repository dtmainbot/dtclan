...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (subcommand === 'user') {
            ...
            message.reply({content: `- <@${targetUser.id}> has been denyed from your clan voice.`, flags: [ 4096 ]});
            ...
            message.reply({content: `- <@&${targetRole.id}> has been denyed from your clan Voice.`, flags: [ 4096 ]});
        } else {
